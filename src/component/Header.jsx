...
export default function Header() {
  ...
  let usercek = user !== null ? user.email : "";
  // if(user === null){
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Nav className="justify-content-end">
            <Nav.Link href="#home">
              <img alt="" width="15em" src={cari} />{" "}
            </Nav.Link>
            <Nav.Link href="#home">
              <img width="15em" src={fill} alt="" />{" "}
            </Nav.Link>
            <Nav.Link href="#home">
              <img width="15em" src={lonceng} alt="" />{" "}
            </Nav.Link>
            <Nav.Link>
              {user !== null ? (
                <NavDropdown title={user !== null ? user.email : ""} style={{ backgroundColor: "black" }}>
                  <NavDropdown.Item>
                    <Nav.Link>
                      <Button
